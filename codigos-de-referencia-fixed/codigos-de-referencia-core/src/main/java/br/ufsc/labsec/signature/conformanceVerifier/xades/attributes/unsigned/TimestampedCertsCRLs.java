...
/**
 * Esta classe representa o atributo TimestampedCertsCRLs
 */
public class TimestampedCertsCRLs implements SignatureAttribute {
    ...
    /**
     * Contrutor usado na verificação.
     ...
     */
    public TimestampedCertsCRLs(AbstractVerifier verifier, Integer index) throws SignatureAttributeException {
    ...
    /**
     * Constrói um objeto {@link TimestampedCertsCRLs}
     * @param attributeEncoded O atributo codificado
     * @throws SignatureAttributeException
     */
    public TimestampedCertsCRLs(Element attributeEncoded) throws SignatureAttributeException {
        decode(attributeEncoded);
    }
    ...
    public String getIdentifier() {
        return TimestampedCertsCRLs.IDENTIFIER;
    }
