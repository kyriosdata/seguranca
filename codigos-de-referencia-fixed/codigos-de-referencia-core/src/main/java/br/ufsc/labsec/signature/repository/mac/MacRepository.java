 ...
 */
public class MacRepository extends Component {
    ...
    private MacCertificateCollection certificateCollection;
    private MacPrivateInformation privateInformation;
    private MacIdentitySelector identitySelector;
     ...
     *            componentes
     */
    public MacRepository(Application application) {
        super(application);
     ...
     */
    MacCertificateCollection getCertificateCollection() {
        if (this.certificateCollection == null) {
            this.certificateCollection = new MacCertificateCollection(this);
        }
     ...
     */
    private MacPrivateInformation getPrivateInformation() {
        if (this.privateInformation == null) {
            this.privateInformation = new MacPrivateInformation(this);
        }
     ...
     */
    private MacIdentitySelector getIdentitySelector() {
        if (this.identitySelector == null) {
            this.identitySelector = new MacIdentitySelector(this);
        }
