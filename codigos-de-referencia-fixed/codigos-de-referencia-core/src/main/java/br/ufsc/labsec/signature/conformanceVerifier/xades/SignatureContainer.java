...
public interface SignatureContainer {
     ...
     * @return A assinatura no índice dado
     * 
     * @throws EncodingException
     */
    public XadesSignature getSignatureAt(int index) throws EncodingException;
     ...
     */
    public ContainedSignatureMode getMode(Integer index) throws SignatureModeException, EncodingException;
}
