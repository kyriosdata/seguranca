 ...
 * 
 * Esse atributo deve conter o conjunto de dados de revogação utilizados
 * para validar o certificado de atributo, quando presente na assinatura.
 * Os dados de revogação usados para validar o certificado de atributos
 * presentes na propriedade RevocationValues não precisam estar presentes neste
 * atributo.
 * 
 * Esquema do atributo AttributeRevocationValues retirado do ETSI TS 101 903:
 * 
 * {@code
 * <xsd:element name="AttributeRevocationValues" type="RevocationValuesType"/>
 * }
 */
public class AttributeRevocationValues implements SignatureAttribute {

    public static final String IDENTIFIER = "AttributeRevocationValues";
    /**
     ...
     */
    public AttributeRevocationValues(AbstractVerifier verifier, Integer index) throws SignatureAttributeException {
     ...
     * @throws SignatureAttributeException
     */
    public AttributeRevocationValues(Element attributeEncoded) throws SignatureAttributeException {
        decode(attributeEncoded);
    }
    ...
    public String getIdentifier() {
        return AttributeRevocationValues.IDENTIFIER;
    }
