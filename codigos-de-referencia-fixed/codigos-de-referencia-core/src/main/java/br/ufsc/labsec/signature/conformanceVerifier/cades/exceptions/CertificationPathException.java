...
public class CertificationPathException extends PbadException {
    ...
    public static final String INVALID_ALGORITHM_PARAMS_OR_ALGORITHM = "Algoritmo inválido ou dados inválidos para usar o algoritmo passado"
            + " para montar o caminho de certificação";
